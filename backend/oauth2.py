...
class Oauth2(ndb.Model):
    ...
    access_token_token = ndb.StringProperty(indexed=False)
    refresh_token_token = ndb.StringProperty(indexed=False)
    ...
    def create(cls, user_key, access_token=None, refresh_token=None):
        ...
        cls._get.lru_set(entity, args=[cls, access_token.token])
    ...
    def expire(self):
        ...
        self.put()
        self._get.lru_set(self, args=[self.__class__, self.access_token.token])
